...
$router->get('/api/current_user1', 'Application\Api\Controller\UserController::getCurrentUser' );

$router->get('/getjson', 'Application\Controller\GetjsonController::getjson' );
$router->post('/renderview', 'Application\Controller\GetjsonController::renderView' );
$router->get('/renderview', 'Application\Controller\GetjsonController::renderView' );
